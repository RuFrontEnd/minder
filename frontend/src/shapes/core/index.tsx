        ...
        if (
          ...
          if (sendToCurve_l) {
            ...
            if (canResizeX) {
              this.curves.l.p2 = {
                ...this.curves.l.p2,
                x: this.curves.l.p2.x + xOffset / 2,
              };
        ...
        if (
          ...
          if (sendToCurve_t) {
            ...
            if (canResizeY) {
              ...
              this.curves.t.p2 = {
                ...this.curves.t.p2,
                y: this.curves.t.p2.y + yOffset / 2,
              };
            }
          }
        }
        ...
        if (
          ...
          if (sendToCurve_r) {
            ...
            if (canResizeX) {
              this.curves.r.p2 = {
                ...this.curves.r.p2,
                x: this.curves.r.p2.x - xOffset / 2,
              };
        ...
        if (
          ...
          if (sendToCurve_b) {
            ...
            if (canResizeY) {
              ...
              this.curves.b.p2 = {
                ...this.curves.b.p2,
                y: this.curves.b.p2.y - yOffset / 2,
              };
            }
          }
        }
        ...
        if (
          ...
          if (sendToCurve_t) {
            ...
            if (canResizeY) {
              ...
              this.curves.t.p2 = {
                ...this.curves.t.p2,
                y: this.curves.t.p2.x + yOffset / 2,
              };
            }
          }
        }
