    ...
    >
      <div className="relative h-full text-grey-2">
        ...
        {onClickSwitch && (
          ...
          >
            <div
              className={`w-6 h-6 inline-flex items-center justify-center rounded-${d[1] === "r" ? "l" : "r"
            ...
            >
              <motion.div
                ...
                transition={{ type: "easeInOut" }}
              >
                <svg className="w-6 h-6 text-white-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
